package com.zhixin.code.generator;
...
public class CodeGeneratorUtil {
	private static String ROOT_PATH = "E:/06_Git/zhixin-kms-parent"; // 代码基本路径

	public static void main(String[] args) throws ResourceNotFoundException, ParseErrorException, Exception {

//		String tablename = "wf_process_instance"; // 数据库表名
//		String classname = "ProcessInstance"; // 类前置（即：子模块名）
//		String moduleName = "repository"; // 模块名
//		String tableDesc = "流程实例表"; // 当前业务模块的概要想描述（表描述）
//		
		String tablename = "t_kms_room"; // 数据库表名
		String classname = "KMSRoom"; // 类前置（即：子模块名）
		String moduleName = "kms"; // 模块名
		String tableDesc = "视频通话房间"; // 当前业务模块的概要想描述（表描述）
		
//		String tablename = "t_kms_caption"; // 数据库表名
//		String classname = "KMSCaption"; // 类前置（即：子模块名）
//		String moduleName = "kms"; // 模块名
//		String tableDesc = "字幕"; // 当前业务模块的概要想描述（表描述）
		
//		String tablename = "t_kms_offline_file"; // 数据库表名
//		String classname = "KMSOffLineFile"; // 类前置（即：子模块名）
//		String moduleName = "kms"; // 模块名
//		String tableDesc = "离线文件"; // 当前业务模块的概要想描述（表描述）
...
//		generator(tablename, classname, moduleName, tableDesc);
	...
	private static void generator(String tablename, String classname, String moduleName, String tableDesc)
		...
		BeanFactory beanFactory = new ClassPathXmlApplicationContext(
				"classpath:/com/zhixin/code/generator/spring-application-ds.xml");
...
//			}
	...
	private static void genertorDomainXML(Context context, String moduleName, String classname)
		...
		Velocity.init();
		// 生成dao层
		Template template = Velocity.getTemplate("com/zhixin/code/generator/" + type + ".vm");
		File domainFile = new File(ROOT_PATH + "/zhixin-kms-dao/src/main/java/com/zhixin/dao/" + moduleName
	...
	private static void genertorService(Context context, String moduleName, String classname)
			throws ResourceNotFoundException, ParseErrorException, Exception {
		String type = "service";
		Velocity.setProperty("input.encoding", "utf-8");
		Velocity.setProperty("output.encoding", "utf-8");
		...
		// 生成dao层
		Template template = Velocity.getTemplate("com/zhixin/code/generator/" + type + ".vm");
		File domainFile = new File(ROOT_PATH + "/zhixin-kms-service/src/main/java/com/zhixin/service/"
		...
		writer.close();
		type = "service.impl";
		template = Velocity.getTemplate("com/zhixin/code/generator/" + type + ".vm");
		domainFile = new File(ROOT_PATH + "/zhixin-kms-service/src/main/java/com/zhixin/service/" + moduleName
	...
	private static void genertorDao(Context context, String moduleName, String classname)
			throws ResourceNotFoundException, ParseErrorException, Exception {
		String type = "dao";
		Velocity.setProperty("input.encoding", "utf-8");
		Velocity.setProperty("output.encoding", "utf-8");
		...
		// 生成dao层
		Template template = Velocity.getTemplate("com/zhixin/code/generator/" + type + ".vm");
		File domainFile = new File(ROOT_PATH + "/zhixin-kms-dao/src/main/java/com/zhixin/dao/" + moduleName + "/I"
				+ classname + "Dao.java");
		if (!domainFile.getParentFile().exists()) {
			domainFile.getParentFile().mkdirs();
		}
		...
		type = "dao.impl";
		template = Velocity.getTemplate("com/zhixin/code/generator/" + type + ".vm");
		domainFile = new File(ROOT_PATH + "/zhixin-kms-dao/src/main/java/com/zhixin/dao/" + moduleName + "/impl/"
	...
	public static void genertorDomain(Context context, String moduleName, String classname)
			throws ResourceNotFoundException, ParseErrorException, Exception {
		String type = "domain";
		Velocity.setProperty("input.encoding", "utf-8");
		Velocity.setProperty("output.encoding", "utf-8");
		...
		// 生成dao层
		Template template = Velocity.getTemplate("com/zhixin/code/generator/" + type + ".vm");
		File domainFile = new File(ROOT_PATH + "/zhixin-kms-dto/src/main/java/com/zhixin/dto/" + moduleName + "/"
				+ classname + "DTO.java");
		if (!domainFile.getParentFile().exists()) {
			domainFile.getParentFile().mkdirs();
		}
	...
	public static void genertorEntity(Context context, String moduleName, String classname)
			throws ResourceNotFoundException, ParseErrorException, Exception {
		String type = "entity";
		Velocity.setProperty("input.encoding", "utf-8");
		Velocity.setProperty("output.encoding", "utf-8");
		...
		// 生成dao层
		Template template = Velocity.getTemplate("com/zhixin/code/generator/" + type + ".vm");
		File domainFile = new File(ROOT_PATH + "/zhixin-kms-entity/src/main/java/com/zhixin/entities/" + moduleName
